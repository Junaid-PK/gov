...
var KTBootstrapMaxlength = function () {
    ...
    var demos = function () {
        ...
        $('#occupation').maxlength({
            alwaysShow: true,
            warningClass: "label label-primary label-rounded label-inline",
            limitReachedClass: "label label-primary label-rounded label-inline"
        });
        $('#passportNum').maxlength({
            alwaysShow: true,
            warningClass: "label label-primary label-rounded label-inline",
            limitReachedClass: "label label-primary label-rounded label-inline"
        });
        $('#confirmPassport').maxlength({
            alwaysShow: true,
            warningClass: "label label-primary label-rounded label-inline",
            limitReachedClass: "label label-primary label-rounded label-inline"
        });
        $('#homeAddress').maxlength({
            alwaysShow: true,
            warningClass: "label label-primary label-rounded label-inline",
            limitReachedClass: "label label-primary label-rounded label-inline"
        });
        ...
        $('#accoSpecify').maxlength({
            alwaysShow: true,
            warningClass: "label label-primary label-rounded label-inline",
            limitReachedClass: "label label-primary label-rounded label-inline"
        });
        $('#purpSpecify').maxlength({
            alwaysShow: true,
            warningClass: "label label-primary label-rounded label-inline",
            limitReachedClass: "label label-primary label-rounded label-inline"
        });
        $('#numLuggageUnAcc').maxlength({
            alwaysShow: true,
            warningClass: "label label-primary label-rounded label-inline",
            limitReachedClass: "label label-primary label-rounded label-inline"
        });
        $('#numLuggageAcc').maxlength({
            alwaysShow: true,
            warningClass: "label label-primary label-rounded label-inline",
            limitReachedClass: "label label-primary label-rounded label-inline"
        });
